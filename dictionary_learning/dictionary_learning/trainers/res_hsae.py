...
class ResHSAE(HierarchicalBatchTopKSAE):
    ...
    def __init__(self, cfg):
        ...
        self.lower_level_latent_sizes = cfg.lower_level_latent_sizes
        ...
        self.encoders.append(
            nn.Linear(current_input_dim, self.dict_size)
        )

        # Higher-level encoders
        prev_level_output_dim = self.dict_size
        for i, latent_size in enumerate(self.lower_level_latent_sizes):
...
class ResHSAETrainer(HierarchicalBatchTopKTrainer):
    ...
    """
    def __init__(self, model: ResHSAE, **kwargs):
