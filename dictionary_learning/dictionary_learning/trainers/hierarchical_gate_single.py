...
class HierarchicalSAE_GatedSingle(nn.Module):
...
class HierarchicalSAEGatedSingleTrainer:
    def __init__(
        ...
        device: Optional[str] = None, wandb_name: str = "HierarchicalSAE_GatedSingle",
